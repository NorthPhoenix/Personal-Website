...
const NierButton = <T extends keyof JSX.IntrinsicElements>({
  ...
  return (
    <Wraper
      className={twMerge(
        "relative cursor-pointer whitespace-nowrap bg-nier-400 p-2 text-center font-helvetica text-base text-nier-700 shadow-md transition duration-200 before:absolute before:inset-0 before:z-[1] before:border-transparent before:transition-all before:duration-200 before:content-[''] after:absolute after:bottom-0 after:left-0 after:top-0 after:-z-[1] after:w-0 after:bg-nier-700 after:transition-all after:duration-200 after:content-[''] hover:bg-transparent hover:text-nier-200 before:hover:-bottom-1 before:hover:-top-1 before:hover:border-y-[0.1rem] before:hover:border-nier-700 after:hover:w-full active:text-nier-700 after:active:bg-nier-200",
        className
      )}
      {...args}>
      {children}
