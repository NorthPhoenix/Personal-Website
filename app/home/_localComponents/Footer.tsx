...
const Footer = () => {
  return (
    <footer className='bg-black text-nier-400'>
      <div className='container mx-auto flex flex-col items-center px-5 py-8 sm:flex-row'>
        ...
        <div className=' mt-4 flex flex-col items-center justify-center sm:ml-4 sm:mt-0 sm:items-start sm:border-l-2 sm:border-nier-400'>
          <p className='text-sm sm:pl-4'>
            2023 — Powered by my remaining brain cells :D
          </p>
          <a
            className='text-sm sm:pl-4'
