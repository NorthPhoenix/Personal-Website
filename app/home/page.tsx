  ...
  return (
    <>
      ...
      <div className='relative overflow-hidden'>
        <div className='absolute left-0 right-0 top-[5%] -z-20 h-[100vw] lg:top-0'>
        ...
        <div className='absolute left-0 right-0 top-[25%] -z-20 h-[100vw] sm:top-[20%] md:top-[22%] lg:top-[20%] xl:top-[33%]'>
          <LinesThroughCircleDesign className='absolute -top-[10%] left-0 h-[90vw] -translate-x-[40%] fill-none stroke-nier-400 opacity-60' />
          <LinesThroughCircleDesign className='absolute right-0 top-[40%] h-[90vw] translate-x-[40%] rotate-180 fill-none stroke-nier-400 opacity-60' />
        </div>
        <div className='absolute left-0 right-0 top-[45%] -z-20 h-[100vw] sm:top-[40%] md:top-[44%] lg:top-[40%] xl:bottom-[5%] xl:top-[unset]'>
          <LinesThroughCircleDesign className='absolute -top-[10%] left-0 h-[90vw] -translate-x-[40%] fill-none stroke-nier-400 opacity-60' />
          <LinesThroughCircleDesign className='absolute right-0 top-[40%] h-[90vw] translate-x-[40%] rotate-180 fill-none stroke-nier-400 opacity-60' />
        </div>
        <div className='absolute bottom-[10%] left-0 right-0 -z-20 h-[100vw] sm:bottom-[7%] md:bottom-[8%] lg:bottom-[7%] xl:hidden'>
          <LinesThroughCircleDesign className='absolute -top-[10%] left-0 h-[90vw] -translate-x-[40%] fill-none stroke-nier-400 opacity-60' />
          <LinesThroughCircleDesign className='absolute right-0 top-[40%] h-[90vw] translate-x-[40%] rotate-180 fill-none stroke-nier-400 opacity-60' />
        </div>
        <DiamondTransition
