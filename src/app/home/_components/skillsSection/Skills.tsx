                      ...
                      <>
                        ...
                        {selected ?
                          <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                            <Check
                              className="h-5 w-5 fill-none text-amber-600"
                              aria-hidden="true"
                            />
                          </span>
                        : null}
              ...
              <div className="bg-nier-200 p-4 text-center shadow-md sm:flex sm:flex-row sm:items-center sm:justify-start md:mt-2 md:flex-col md:gap-2 md:px-2 md:py-4">
                ...
                <div className="contents sm:ml-2 sm:block md:ml-0 md:contents">
                  ...
                  {!!activeSkill.link && (
                    ...
                    >
                      <Link className="mb-1 inline-block h-5 w-5 fill-none text-nier-700 transition-all duration-200 ease-in-out group-hover:text-nier-200 group-active:text-nier-700" />
