      ...
      <div className="container mx-auto flex flex-col items-center px-5 py-8 sm:flex-row">
        ...
        <div className=" mt-4 flex flex-col items-center justify-center opacity-70 sm:ml-4 sm:mt-0 sm:items-start sm:border-l-2 sm:border-nier-400">
          <p className="text-xs sm:pl-4 md:text-sm">
            Created with Next.js and Outstatic
          </p>
          <p className="text-xs sm:pl-4 md:text-sm">
            2024 — Powered by my remaining brain cells :D (and Vercel)
          </p>
        </div>
        <div className="mt-6 flex justify-center gap-3 sm:ml-auto sm:mt-0 sm:justify-start">
          <Link
            prefetch={false}
            target="_blank"
          ...
          >
            <svg
              ...
              y="0px"
              viewBox="0 0 24 24"
              className="h-6 w-6 fill-current text-nier-400"
            >
              <g>
                <path
                  fillRule="evenodd"
