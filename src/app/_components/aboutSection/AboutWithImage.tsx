...
const AboutWithImage = () => {
  ...
  return screenSize === "xs" || screenSize === "sm" ?
      <section
        id="about"
        className="relative mb-16 flex w-full items-center justify-center overflow-y-visible p-2 py-12 pt-20 font-helvetica"
      >
        <article className="nier-block-left-sm relative ml-4 mr-2 flex min-h-[40vmin] w-full flex-col items-start justify-center py-5">
          ...
          >
            ...
            >
              ...
              Dallas, and I'm excited to start my career in the industry.
            </motion.p>
          </motion.div>
            ...
            >
              <div className="basis-2/3 px-4">
                ...
                <p className="text-lg ">
                  ...
                  University of Texas at Dallas, and I'm excited to start my
